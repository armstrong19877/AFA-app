    ...
    @section("title", "Edit interests")
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="container-sm-1 justify-center align-items-center mt-5 m-sm-5">
                <form class="" method="post" action="{{url('admin/interests/'.$hob->id.'/update')}}">
                    @csrf
                    @method('put')
                    <div class="container">
                        <div class="row justify-content-around align-items-center text-center mx-auto">
                            <div class="col col-xxl-1 col-xl-2 col-lg-4 col-md-6 col-sm-12 ">
                                <div class="mb-3 mt-4">
                                    <input type="text"class="form-control" style="width:18rem; height: 3.5rem;" name="my_interest" value="{{$hob->my_interest}}" id=""aria-describedby="helpId" placeholder="{{$hob->my_interest}}"/>
                                </div>
                                <div class="mb-3">
